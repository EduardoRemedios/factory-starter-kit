...
|-----------|--------|-------|
| Phase 1 V3 real-project trial batch | Next | Record 5 trials with `PHASE1_TRIAL_PLAN.md`; 3 of 5 are recorded, including two fallback cases and one completed Harmony happy-path implementation. |
