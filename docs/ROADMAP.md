...
| SPRINT_20260624_001 | Add review/merge handoff discipline | Done | 2026-06-24 | `docs/Conductor/MERGE_PROTOCOL.md` |
| SPRINT_20260624_002 | Add non-technical onboarding path | Done | 2026-06-24 | `docs/onboarding/NON_TECHNICAL_STARTER_GUIDE.md` |
| SPRINT_20260625_001 | Add Kilo model-routed stage lanes | Done | 2026-06-25 | `docs/Conductor/Harnesses/KILO.md`; `./scripts/conductorctl kilo-stage` |
| SPRINT_20260702_001 | Formalize Stage A direct-source recall repair | Done | 2026-07-02 | `docs/Conductor/ORCHESTRATION.md`; `scripts/conductor_pack_lint.py`; `tests/test_context_recall_repair.py` |
| SPRINT_20260724_001 | Build and pilot dual-platform Factory plugin | Codex pre-pilot passed; Claude and formal pilot pending | 2026-07-24 | `docs/onboarding/CONDUCTOR_PLUGIN_PILOT_RUNBOOK.md` |
| SPRINT_20260805_002 | Harden generic Factory plugin prerequisites and RC 0.2.0 | REVIEW_READY | 2026-08-05 | `docs/CHANGELOG.md` |
| SPRINT_20260805_003 | Finalize Factory plugin RC 0.2.0 and execution closeout | REVIEW_READY | 2026-08-05 | `scripts/conductor_execution_closeout.py`; `tests/test_conductor_execution_closeout.py` |
| SPRINT_20260805_004 | Repair Factory plugin run-root path safety | REVIEW_READY | 2026-08-05 | `tests/test_conductor_execution_closeout.py`; `tests/test_conductor_project_preflight.py` |
| SPRINT_20260805_005 | Reverify release evidence and public release scope | REVIEW_READY | 2026-08-05 | `python3 -m unittest discover -s tests -v`; `python3 scripts/build_conductor_plugins.py --check` |
| SPRINT_20260810_001 | Repair Greenfield CLI empty-target bootstrap | REVIEW_READY | 2026-08-10 | `tests/test_conductor_plugin_cli.py`; `docs/onboarding/CONDUCTOR_PLUGIN_QUICK_START.md` |
| SPRINT_20260810_002 | Preserve exact Claude-local metadata during Greenfield bootstrap | REVIEW_READY | 2026-08-10 | `tests/test_conductor_plugin_setup_plan.py`; `tests/test_conductor_plugin_lifecycle.py` |
...
| SPRINT_20260812_006 | Repair the Factory and Factory-BMAD 0.2.1 lifecycle | REVIEW_READY; final Factory contract repairs integrated | 2026-08-13 | `scripts/conductor_pack_lint.py`; `tests/test_conductor_pack_lint_activation_verification.py` |
| SPRINT_20260814_001 | Repair and qualify Factory and Factory-BMAD 0.2.2 | FIXED_AWAITING_RETEST; deterministic qualification passed | 2026-08-14 | `docs/adapters/bmad/CONDUCTOR_BMAD_PILOT_BACKLOG.md`; `tests/test_conductor_pack_lint_core.py` |
| SPRINT_20260815_001 | Recover and qualify Factory and Factory-BMAD 0.2.3 | AMENDED_SOURCE_LIVE_QUALIFIED; publication pending | 2026-08-15 | `artifacts/verification/conductor_bmad_023_recovery/LIVE_REQUALIFICATION_ADAPTER_REPAIR.md` |
| SPRINT_20260822_001 | Repair Factory-BMAD first-tester cache integrity blocker | REVIEW_READY; first-tester matrix passed, F10 repaired and tester-smoked in 0.2.4 | 2026-08-22 | `scripts/verify_conductor_bmad_cli_rollout.py`; `docs/adapters/bmad/CONDUCTOR_BMAD_FIRST_TESTER_HANDOFF.md` |
| SPRINT_20260824_001 | Prepare Claude Code CLI first-team rollout polish | REVIEW_READY | 2026-08-24 | `plugin-src/conductor/runtime/conductor_plugin.py`; `plugin-src/conductor-bmad/runtime/conductor_bmad.py`; `docs/adapters/bmad/CONDUCTOR_BMAD_CLI_ROLLOUT_PLAYBOOK.md` |
| SPRINT_20260902_001 | Integrate 0.2.5 solution-context authoring boundary | QUALIFIED; MS-01 through MS-05 closed, canonical closeout `REVIEW_READY`, human review accepted 2026-09-03, status `CONDUCTOR_BMAD_025_INTEGRATION_DETERMINISTICALLY_QUALIFIED`; MS-06 and rollout separately gated | 2026-09-03 | `plugin-src/conductor-bmad/project-adapter/conductor_project_preflight`; `tests/plugin_fixtures/conductor_bmad_solution_context_contract.json` |
