...
|-----------|--------|-------|
| Promotion-evidence real-branch warning review | Next | Requires human GO against `RUN_20260518_1508_v3_promotion_evidence_plan`; exercise a future real-doc branch that tests promotion-evidence warnings without retaining unsafe release language. |
