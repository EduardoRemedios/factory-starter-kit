...
| Existing repository, both present | Govern handoff | Run `/conductor-bmad:audit`, then intake, promote reviewed evidence, and cite only promoted snapshots in Factory briefs. |
