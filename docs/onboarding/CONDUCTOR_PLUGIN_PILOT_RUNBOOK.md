...
Decide whether the Conductor plugin 0.3.1 is ready for a team rollout using named
...
- `python3 scripts/verify_conductor_cli_rollout.py --json` returns no `BLOCKED`
...
```text
artifacts/verification/conductor_plugin/pilot/<YYYYMMDD>/<user>/
```
