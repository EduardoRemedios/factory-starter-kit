...
## Changes Made
- Captured failure scenarios and risk hooks for V3 eval evolution.

## Assumptions
- Operational confidence requires real pilots, not only fixtures.
...
### NON-BLOCKING
- Natural-language detection risk requires pilot evidence.
