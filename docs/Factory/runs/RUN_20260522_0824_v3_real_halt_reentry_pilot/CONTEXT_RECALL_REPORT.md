...
- Requested Scope: RUN_20260522_0824_v3_real_halt_reentry_pilot
- Effective Scope: docs
- Attempted Scopes: RUN_20260522_0824_v3_real_halt_reentry_pilot, docs/Factory/runs, docs/Factory/ProductOwner/phases, docs
- Fallback Applied: YES
- Coverage Verdict: SUFFICIENT
- Generated At (UTC): 2026-05-22T07:24:46Z
...
## Coverage Snapshot
- Indexed sources in effective scope: 344
- Artifact types: {"canonical_doc": 54, "factory_run_pack_artifact": 224, "factory_run_root_artifact": 66}
- Focus terms: None
- Trace IDs: None
- Required refs: docs/Factory/v3/OPERATIONAL_DECISION_CHECKLIST.md, docs/Factory/runs/RUN_20260521_0948_v3_confidence_pilot_execution/EXECUTION_CLOSEOUT.md, docs/Factory/runs/RUN_20260521_0948_v3_confidence_pilot_execution/execution_evidence/CONFIDENCE_PILOT_BATCH_ROLLUP.md
...
- Result count: 391
- Evidence:
  - `docs/PROJECT_STATE.md:39` [PROJECT_STATE.md — Canonical Build State > Current Tracking Snapshot]
...
### R2. `docs/Factory/runs/RUN_20260521_0948_v3_confidence_pilot_execution/EXECUTION_CLOSEOUT.md`
- Status: RESOLVED
- Resolution Type: path
- Evidence:
  - `docs/Factory/runs/RUN_20260521_0948_v3_confidence_pilot_execution/EXECUTION_CLOSEOUT.md` (factory_run_root_artifact)

### R3. `docs/Factory/runs/RUN_20260521_0948_v3_confidence_pilot_execution/execution_evidence/CONFIDENCE_PILOT_BATCH_ROLLUP.md`
- Status: RESOLVED
- Resolution Type: path
- Evidence:
  - `docs/Factory/runs/RUN_20260521_0948_v3_confidence_pilot_execution/execution_evidence/CONFIDENCE_PILOT_BATCH_ROLLUP.md` (factory_run_root_artifact)
