...
| `schemas/*.schema.json` | JSON Schema 2020-12 drafts: intent_pack, verification_manifest_v2, statement_of_completion, gap_request, project_config, lane_policy, evidence_receipt, countersign |
...
|---|---|
| Every §5 contract has a field-level schema sketch | 03 + `schemas/` (8 files) |
