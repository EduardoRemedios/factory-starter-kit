...
- v4.3 (2026-02-27): Added Mission Mode naming contract (`docs/Conductor/missions/<MISSION_ID>/` with required `MISSION_*` artifacts).
...
- Factory specs: `docs/Conductor/Spec/`
- Templates: `docs/Conductor/templates/`
- Product Owner docs: `docs/Conductor/ProductOwner/`
- Runs: `docs/Conductor/runs/`
- Missions: `docs/Conductor/missions/`
...
- `docs/Conductor/missions/<MISSION_ID>/`
...
- `SPRINT_YYYYMMDD_NNN`
- assigned in `STAGE_H`
- stored in `docs/Conductor/runs/<RUN_ID>/SPRINT_ID.txt`

## 5. Required artifact filenames (HARD)
Within `docs/Conductor/runs/<RUN_ID>/pack/`:
...
Within `docs/Conductor/missions/<MISSION_ID>/`:
- `MISSION_MANIFEST.md`
