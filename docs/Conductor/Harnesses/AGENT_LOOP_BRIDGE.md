...
3. Extract messages with exactly one fenced JSON block and `event_type: "conductor.handoff.v1"`.
...
8. Produce one `conductor.review_result.v1` payload.
...
The handoff message must include exactly one fenced JSON block with `event_type: "conductor.handoff.v1"`.

```json
{
  "event_type": "conductor.handoff.v1",
  ...
  "evidence_paths": {
    "pack": "docs/Conductor/runs/RUN_YYYYMMDD_HHMM_factory/pack/",
    "pack_audit": "docs/Conductor/runs/RUN_YYYYMMDD_HHMM_factory/pack/PACK_AUDIT_REPORT.md",
    "pack_checklist": "docs/Conductor/runs/RUN_YYYYMMDD_HHMM_factory/pack/PACK_CHECKLIST.md",
...
```json
{
  "event_type": "conductor.review_result.v1",
