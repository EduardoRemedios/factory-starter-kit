...
3. `docs/ROADMAP.md`
4. `docs/Conductor/SCRATCHPAD.md` Active Pitfalls only
...
When conducting research, the PO must follow the controls in `docs/Conductor/ORCHESTRATION.md` section 0.2:
1. domain allowlist
