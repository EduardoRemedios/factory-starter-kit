...
- A standalone advisory Factory v3 mission-record validator exists at `scripts/factory_v3_mission_record_lint.py`.
- Malformed mission-record fixtures and deterministic expected-output fixtures exist under `tests/fixtures/factory_v3_mission_record/`.
...
- Latest V3 Phase 2 shadow-record result: v0 mission-record design, five trial-derived JSON examples, six malformed-record fixtures, deterministic expected outputs, and a standalone advisory validator exist; no enforcement, gate integration, telemetry, governance routing, runtime authority, or new V3 profile is approved.
...
- Phase 1 trial operating plan, index, capture template, two fallback trial records, three happy-path implementation trials, owner waiver, decision review, Phase 2 v0 shadow mission-record design, malformed-record fixtures, and a standalone advisory validator exist; Phase 2 does not have enforcement, telemetry, governance routing, or operational promotion.
...
# Run the standalone Factory v3 mission-record advisory validator and deterministic fixture checks
python3 scripts/factory_v3_mission_record_lint.py --target tests/fixtures/factory_v3_mission_record --json
python3 scripts/factory_v3_mission_record_lint.py --target tests/fixtures/factory_v3_mission_record/trial_003_harmony_faq_ingestion.json --expect tests/fixtures/factory_v3_mission_record/expected/valid_trial_003.json --json
python3 scripts/factory_v3_mission_record_lint.py --target tests/fixtures/factory_v3_mission_record/invalid --expect tests/fixtures/factory_v3_mission_record/expected/invalid.json --json
