...
const assertions = [
  ...
  ["two-or-three-person pod", "two or three accountable generalists"],
  ["AI-native product engineer", "AI-Native Product Engineer"],
  ["independent assurance", "A shared Product Assurance Lead joins at defined review gates"],
