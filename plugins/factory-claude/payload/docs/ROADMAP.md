...
| Factory plugin rollout | REVIEW_READY | Public-scope review and automated verification are complete; next complete the first-time-user pilot, release decisions, and Product Owner sign-off. |
