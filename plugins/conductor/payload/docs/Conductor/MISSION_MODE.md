# docs/Conductor/MISSION_MODE.md — Mission Mode (Factory Extension)
...
1. refresh the artifact recall index with `./scripts/conductorctl context-index`
2. generate `docs/Conductor/missions/<MISSION_ID>/MISSION_CONTEXT_RECALL_REPORT.md` with `./scripts/conductorctl context-report --profile mission-checkpoint --scope <MISSION_ID> --output docs/Conductor/missions/<MISSION_ID>/MISSION_CONTEXT_RECALL_REPORT.md`
...
Adapter artifacts:
- `docs/Conductor/missions/<MISSION_ID>/MISSION_CURSOR.json`
