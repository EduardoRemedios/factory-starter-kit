...
- `docs/ROADMAP.md`
- `docs/Conductor/SCRATCHPAD.md` Active Pitfalls
...
Store at:
- `docs/Conductor/ProductOwner/phases/<PHASE_ID>/PHASE_STATE.md`
- `docs/Conductor/ProductOwner/phases/<PHASE_ID>/PHASE_INTENT.md`
...
- Path: `docs/Conductor/ProductOwner/phases/<PHASE_ID>/BRIEF_SPRINT_<N>_CONTEXT_RECALL_REPORT.md`
- Command:
  - `./scripts/conductorctl context-report --profile po-brief --scope <PHASE_ID> --output docs/Conductor/ProductOwner/phases/<PHASE_ID>/BRIEF_SPRINT_<N>_CONTEXT_RECALL_REPORT.md`
...
2. `docs/Conductor/ProductOwner/phases`
3. `docs/Conductor/runs`
4. `docs`
...
| Item | Path |
|------|------|
| This process guide | `docs/Conductor/ProductOwner/PO_PROCESS.md` |
| PO role definition | `docs/Conductor/ProductOwner/PO_ROLE_DEFINITION.md` |
| Phase Brief template | `docs/Conductor/ProductOwner/templates/PHASE_BRIEF_TEMPLATE.md` |
| Phase Intent template | `docs/Conductor/ProductOwner/templates/PHASE_INTENT_TEMPLATE.md` |
| Phase Intent Review Checklist | `docs/Conductor/ProductOwner/PHASE_INTENT_REVIEW_CHECKLIST.md` |
| Brief Review Checklist | `docs/Conductor/ProductOwner/BRIEF_REVIEW_CHECKLIST.md` |
| Phase State template | `docs/Conductor/ProductOwner/templates/PHASE_STATE_TEMPLATE.md` |
| Phase artifacts | `docs/Conductor/ProductOwner/phases/<PHASE_ID>/` |
| Context recall report template | `docs/Conductor/templates/CONTEXT_RECALL_REPORT_TEMPLATE.md` |
