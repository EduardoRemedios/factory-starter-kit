...
<!--
VALIDATION:
- Create at: docs/Conductor/runs/<RUN_ID>/pack/PACK_MANIFEST.md
- Validation scope is completeness only: existence + non-empty checks; no content parsing required.
- Required pack files MUST match docs/Conductor/Spec/NAMING_CONVENTIONS.md §5.
- Required run-root files MUST match docs/Conductor/Spec/NAMING_CONVENTIONS.md §2.
