...
<!--
VALIDATION:
- Create at: docs/Conductor/missions/<MISSION_ID>/MISSION_MANIFEST.md
...
|---:|---|---|---|---|---|---|
| 1 | UNIT-01 | RUN_... | SPRINT_... | docs/Conductor/runs/<RUN_ID>/pack | none | planned |
| 2 | UNIT-02 | RUN_... | SPRINT_... | docs/Conductor/runs/<RUN_ID>/pack | 1 | planned |
