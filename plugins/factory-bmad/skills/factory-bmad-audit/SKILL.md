---
name: factory-bmad-audit
description: Audit installed BMAD modules, commands, skills, agents, hooks, configuration, versions, policy coverage, and brownfield evidence without mutation.
---
...
non-destructive brownfield reconciliation summary. `bmad-loop` blocks
