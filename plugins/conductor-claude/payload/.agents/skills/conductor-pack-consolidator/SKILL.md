---
name: conductor-pack-consolidator
...
1. Read `docs/Conductor/Spec/STAGE_CONTRACTS.md`, `docs/Conductor/Spec/PURPLE_GATE_CHECKLIST.md`, and `docs/Conductor/templates/PACK_MANIFEST_TEMPLATE.md`.
...
7. Run `./scripts/conductorctl stage-lint --run <RUN_ID> --stage J` after writing the handoff.
