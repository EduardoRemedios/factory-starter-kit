...
<!--
VALIDATION:
- Create at: docs/Conductor/missions/<MISSION_ID>/MISSION_EXECUTION_PROMPT.md
...
## Required Read Order
1. `AGENTS.md`
2. `docs/Conductor/ORCHESTRATION.md`
3. `docs/Conductor/MISSION_MODE.md`
4. `docs/Conductor/missions/<MISSION_ID>/MISSION_MANIFEST.md`
5. `docs/Conductor/missions/<MISSION_ID>/MISSION_CHECKPOINT.md`
