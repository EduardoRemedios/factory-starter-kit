...
<!--
VALIDATION:
- Generic template for context recall artifacts generated by `scripts/conductorctl context-report`.
- Supported concrete outputs:
  ...
  - `docs/Conductor/ProductOwner/phases/<PHASE_ID>/BRIEF_SPRINT_<N>_CONTEXT_RECALL_REPORT.md`
