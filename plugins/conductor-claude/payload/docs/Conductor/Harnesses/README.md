...
- `./scripts/conductorctl pack-lint`
...
4. Generate Stage A recall with `./scripts/conductorctl context-report`.
5. Run `./scripts/conductorctl pack-lint --run <RUN_ID>` after I2 and before human review.
