...
- start with `docs/onboarding/CONDUCTOR_PLUGIN_QUICK_START.md`
- use `docs/onboarding/CONDUCTOR_PLUGIN_CLI_ROLLOUT_PLAYBOOK.md` before piloting
- keep `docs/onboarding/CONDUCTOR_PLUGIN_REFERENCE.md`, `docs/onboarding/CONDUCTOR_PLUGIN_TROUBLESHOOTING.md`, and `docs/onboarding/CONDUCTOR_PLUGIN_ROLLBACK.md` available during adoption
- use `docs/onboarding/CONDUCTOR_PLUGIN_PILOT_RUNBOOK.md` for the first team rollout
...
6. review the default recall source patterns in `scripts/conductor_context_index.py`
...
3. run `./scripts/conductorctl context-index`
