...
from conductor_pack_lint import (
...
def lint_stage(root: Path, run: str, stage: str) -> dict[str, Any]:
    ...
    if stage == "A":
        declaration = root / "docs" / "Conductor" / "PROJECT_PREFLIGHT.json"
        if declaration.exists():
            ...
            if not project_preflight.is_file():
                ...
                if "reason_code: CONDUCTOR_PROJECT_PREFLIGHT_PASS" not in preflight_text:
                    errors.append(
