...
from tests.test_factory_bmad_support import runtime, seed_factory
from tests.test_factory_plugin_cli import runtime_for
...
class FactoryBmadOutputTests(unittest.TestCase):
    ...
    def test_bootstrap_apply_requires_a_fresh_claude_session_before_intake(self):
        payload = runtime.result(
            "APPLIED",
            "FACTORY_BMAD_BOOTSTRAP_APPLIED",
    ...
    def test_factory_authored_cli_is_concise_by_default_and_json_on_request(self):
