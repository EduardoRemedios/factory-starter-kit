...
from factory_pack_lint import WORD_CAPS, check_word_cap  # noqa: E402
...
class FactoryStageOutputPathTests(unittest.TestCase):
    ...
    def test_accepts_nonempty_run_relative_file(self):
        with tempfile.TemporaryDirectory() as temp_dir:
            root = Path(temp_dir)
            write(root / "docs/Factory/runs/RUN_20260813_0000_fixture/pack/evidence.txt", "ok\n")
    ...
    def test_rejects_missing_or_empty_targets(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            root = Path(temp_dir)
            write(root / "docs/Factory/runs/RUN_20260813_0000_fixture/pack/empty.txt", "")
    ...
    def test_rejects_symlink_escape(self):
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            link = root / "docs/Factory/runs/RUN_20260813_0000_fixture/pack/link"
