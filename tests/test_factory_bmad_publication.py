...
SPEC = importlib.util.spec_from_file_location("publication", ROOT / "scripts/verify_factory_bmad_publication.py")
...
class PublicationBoundaryTests(unittest.TestCase):
    def test_internal_evidence_is_never_public(self):
        ...
        self.assertFalse(publication.public_path("docs/Factory/runs/RUN_x/raw_brief.md"))

    def test_expected_product_paths_are_public(self):
        self.assertTrue(publication.public_path("plugin-src/factory-bmad/manifest.json"))
        self.assertTrue(publication.public_path("tests/test_factory_bmad_policy.py"))
...
class CloneVerificationTests(unittest.TestCase):
    ...
    def candidate(self):
        ...
        return {
            "schema": "factory.publication-candidate.v1",
