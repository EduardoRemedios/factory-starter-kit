...
def dependency_result(
    *, factory_version: str | None, enabled: bool, required: str = "=0.2.5"
) -> dict[str, object]:
        ...
        json.dumps(
            {
                ...
                "dependencies": [{"name": "factory", "version": "=0.2.5"}],
            },
            indent=2,
        )
        + "\n",
...
class FactoryPluginCompositionTests(unittest.TestCase):
    ...
    def test_cp01_exact_dependency_and_local_release_tag(self):
        ...
        self.assertEqual(
            ...
            dependency_result(factory_version="0.2.5", enabled=True),
        )
    ...
    def test_cp02_cp03_cp04_dependency_failures_halt(self):
        ...
        self.assertEqual(
            "dependency-unsatisfied",
            dependency_result(factory_version="0.2.5", enabled=False)["reason"],
        )
        self.assertEqual(
