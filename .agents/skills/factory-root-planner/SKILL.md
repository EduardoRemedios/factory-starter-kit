...
4. If `docs/Factory/PROJECT_PREFLIGHT.json` exists, run `./scripts/factoryctl project-preflight --run <RUN_ID>` after knowledge lint and before context recall; persist/pass `PROJECT_PREFLIGHT.txt` or halt.
