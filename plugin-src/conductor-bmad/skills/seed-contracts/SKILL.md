---
name: seed-contracts
description: Preview or seed the inert Conductor BMAD adapter contracts (adapter config schema, lane policy schema and JSON, authority policy) into a repository so contract-lint can validate a declared BMAD adapter, independent of intake.
---
