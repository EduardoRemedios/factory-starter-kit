...
4. Run Factory-controlled Python verification through `./scripts/conductor-python`; run other canonical repository commands with `PYTHONDONTWRITEBYTECODE=1` in the environment so validation does not create `__pycache__` or `.pyc` files.
